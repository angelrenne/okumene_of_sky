 ...
 * @version 1.01 2015/11/08 角度の誤計算を修正、ループマップ使用可能
...
// (function() {
    ...
    Game_AnalogMove.prototype.followCharacter = function(thisCharacter, targetCharacter) {
        ...
        if (!thisCharacter.canMove()) {
            this._distancePerFrame = 0.0;
        } else if (deltaXYFromTarget < 1.1) {
            this._distancePerFrame = thisCharacter.distancePerFrame() * 0.0;
        } else if (deltaXYFromTarget < 1.5) {
            this._distancePerFrame = thisCharacter.distancePerFrame() * 1.0;
        } else if (deltaXYFromTarget < 2.0) {
            this._distancePerFrame = thisCharacter.distancePerFrame() * 1.5;
        } else {
            this._distancePerFrame = thisCharacter.distancePerFrame() * 2.0;
        }
    };
    ...
    Game_AnalogMove.prototype.collideCharacters = function(thisCharacter, distancePerFrame) {
        ...
        var priorityFilter = function(character, index, array) {
            return (character != thisCharacter &&
        ...
        var distanceFilter = function(character, index, array) {
            ...
            return (nextDistance < crntDistance && nextDistance < 1.0 - distancePerFrame);
        };
        var self = this;
        ...
        collideCharacters.sort(distanceCompare);
    ...
    Game_CharacterBase.prototype.initMembers = function() {
        ...
        this.setAnalogMoveValid(PluginManager.parameters('AnalogMove')['Valid'] === 'ON')
    };
    
    // キャラクターベースクラスの移動中判定
    var _rn_AnalogMove_Game_CharacterBase_isMoving = Game_CharacterBase.prototype.isMoving;
    Game_CharacterBase.prototype.isMoving = function() {
        if (this.isAnalogMoveValid()) return this._analogMove.isMoving();
    ...
    Game_CharacterBase.prototype.update = function() {
        if (this.isAnalogMoveValid()) this._analogMove.update(this);
    ...
    Game_Character.prototype.updateRoutineMove = function() {
        if (this.isAnalogMoveValid()) return;
    ...
    Game_Player.prototype.isAnalogMoveValid = function() {
        return Game_Character.prototype.isAnalogMoveValid.call(this) && !this._followers.areGathering();
    };
